-- Búsquedas por fecha específica (operación contable)
...
-- Filtros temporales (rango de tiempo con TIME)
...
-- Recuperación de información histórica desde JSON
...
-- Análisis por año fiscal (uso de YEAR)
